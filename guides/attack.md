---
when: attacking an open problem, stuck, hard conjecture, where to start, is this too hard, compute budget, 60 second rule, long-running script, timeout, search strategy, verifying your own answer, priors about difficulty, giving up
---
