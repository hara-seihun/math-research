...
List tools shorten summaries so a page of results stays scannable. `get` has the full text, a page at a time for a long one: `content_range` says where you are in the body and `content_offset` walks it.
