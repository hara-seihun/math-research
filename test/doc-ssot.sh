...
known_placeholders='mathlib_version|lean_version|how_it_works_digest|ledger_snapshot|accomplishments_snapshot|tool_reference|resource_reference|prompt_reference|live_js'
