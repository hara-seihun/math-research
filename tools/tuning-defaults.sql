...
insert into config (key, value) values
  ('notability_weights', '{
    "kind": {"theorem":3.0,"tool":3.0,"front":3.0,"theory":3.0,"proof":2.5,
             "correspondence":2.5,"counterexample":2.0,"conjecture":2.0,"result":2.0,
             "reformulation":1.8,"definition":1.5,
             "problem":1.5,"route":1.5,"computation":1.0,"exposition":0.8,"statement":0.6,
